...
with(feb_2day_power_consp_fmtd, plot(Datetime, Voltage, xlab = "datetime", ylab = "Voltage", type = "l"))
...
with(feb_2day_power_consp_fmtd, plot(Datetime, Global_reactive_power, xlab = "datetime", type = "l"))
